...
node scripts/diff_advanced.cjs
node scripts/diff_test.cjs
node scripts/affected_domains.cjs
...
pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/expiry_check.ps1
...
pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/record_top_failed_domains.ps1
...
if (Test-Path 'reports/smoke-top-failed.md') { $dashboard += "- smoke-top-failed.md" }
