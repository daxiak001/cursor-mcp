...
- 策略与门禁（S2）：
  ...
  - 新工件（CI）：reports/tests-to-run.txt（高级选测）、reports/affected-domains.{txt,json}（受影响域）、reports/policy-report.{json,md}、reports/interface-diff.{json,md}、reports/ci-dashboard.md（汇总）
